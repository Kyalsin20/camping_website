$(function () {
  ...
  function change () {
    ++i
    $($('main div')[i - 1])
      .animate({ 'min-width': '10%' }, 0.01)
      .removeClass('a')
    $($('.slide li')[i - 1]).removeClass('b')
    if (i == 5) {
      i = 0
    }
    $($('main div')[i]).animate({ 'min-width': '50%' }).addClass('a')
  ...
  $('main div').click(function () {
    ...
    if ($(this).hasClass('a')) {
      ...
      $('main div').animate({ 'min-width': '10%' }, 0.5).removeClass('a')
      $('.slide li').removeClass('b')
      $(this).animate({ 'min-width': '50%' }, 200).addClass('a')
  ...
  $('span').click(function () {
    ...
    if (j == 0 && $(this).hasClass('prev')) {
      $($('main div')[0])
        .animate({ 'min-width': '10%' }, 0.01)
        .removeClass('a')
        .addClass('commentsclose')
      $($('.slide li')[0]).removeClass('b')
      $($('main div')[4]).animate({ 'min-width': '50%' }, 200).addClass('a')
      ...
      $($('main div')[0]).animate({ 'min-width': '50%' }, 200).addClass('a')
      ...
      if ($(this).hasClass('prev')) {
        ...
        $($('main div')[j - 1])
          .animate({ 'min-width': '50%' }, 200)
          .addClass('a')
          .removeClass('commentsclose')
